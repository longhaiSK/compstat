...
::: {#fig-hmc-app .content-visible when-format="html"}
...
**Shinylive App Illustrating Hamiltonian Monte Carlo Tuning.** The app below runs the `hmc()` function above on the same correlated target
