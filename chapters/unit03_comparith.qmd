...
m <- outer(1:9, 0:9, function(a, b) a + b / 10)
...
\begin{array}{rcccl}
 & \text{sign} & \text{exponent} & \text{mantissa} & \text{decimal value}\\[6pt]
1 & \underbrace{\bx{0}}_{1\text{ bit}}
  & \underbrace{\bx{0}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}}_{11\text{ bits}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\cdots\bx{0}\bx{0}\bx{0}}_{52\text{ bits}}
  & = 1\\[16pt]
1+\epsilon & \underbrace{\bx{0}}_{1\text{ bit}}
  & \underbrace{\bx{0}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}}_{11\text{ bits}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\cdots\bx{0}\bx{0}\bx{1}}_{52\text{ bits}}
  & = 1+2^{-52} \approx 1 + 2.220446\times10^{-16}\\[16pt]
\text{largest} & \underbrace{\bx{0}}_{1\text{ bit}}
  & \underbrace{\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{1}\bx{0}}_{11\text{ bits}}
  & \underbrace{\bx{1}\bx{1}\bx{1}\cdots\bx{1}\bx{1}\bx{1}}_{52\text{ bits}}
  & = (2-2^{-52})\times2^{1023} \approx 1.797693\times10^{308}\\[16pt]
\text{smallest normal} & \underbrace{\bx{0}}_{1\text{ bit}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{1}}_{11\text{ bits}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\cdots\bx{0}\bx{0}\bx{0}}_{52\text{ bits}}
  & = 2^{-1022} \approx 2.225074\times10^{-308}\\[16pt]
\text{smallest positive} & \underbrace{\bx{0}}_{1\text{ bit}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}\bx{0}}_{11\text{ bits}}
  & \underbrace{\bx{0}\bx{0}\bx{0}\cdots\bx{0}\bx{0}\bx{1}}_{52\text{ bits}}
  & = 2^{-1074} \approx 4.940656\times10^{-324}
\end{array}
$$

The rows $1$ and $1+\epsilon$ differ only in the last mantissa box, which is worth $2^{-52}=\epsilon$. The largest double uses the largest usable exponent code $2046$ and a full mantissa. The smallest normal double uses the smallest usable code $1$ and mantissa $1.0$; the smallest positive (subnormal) double uses code $0$, which drops the implicit leading $1$, and only the last mantissa box.
...
<p class="cap">The red digit does not fit and is rounded away: the stored result is exactly $1.000$</p>
...
```{tikz}
%| label: fig-large-plus-small
%| echo: false
%| fig-cap: "Roundoff error when adding a large and a small number"
%| fig-align: center
\usetikzlibrary{positioning}
\begin{tikzpicture}[font=\sffamily]
  \node at (-1, 1) {$1.$};
  \draw[thick] (0, 0.75) rectangle (6, 1.25) node[midway] {$00\dots00$ (52 bits)};
  \node at (-2, 0.25) {\Large $+$};
  \node at (-1, -0.5) {$0.$};
  \draw[thick] (0, -0.75) rectangle (6, -0.25) node[midway] {$00\dots00$ (52 bits)};
  \draw[thick, red, fill=red!10] (6.2, -0.75) rectangle (7.2, -0.25) node[midway] {$01$};
  \node[red, above] at (6.7, -0.25) {Truncated (Lost)};
  \draw[red, ultra thick] (6.2, -0.75) -- (7.2, -0.25);
  \draw[red, ultra thick] (6.2, -0.25) -- (7.2, -0.75);
  \draw[thick] (-2, -1.25) -- (8, -1.25);
  \node at (-1, -2) {$1.$};
  \draw[thick] (0, -2.25) rectangle (6, -1.75) node[midway] {$00\dots00$ (52 bits)};
\end{tikzpicture}
```
