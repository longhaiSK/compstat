...
```{tikz, fig.cap="A Model for Understanding Floating Point Numbers: Overflow and Underflow Regions", fig.align="center"}
%| echo: false
...
```{tikz, fig.cap="Visualizing Roundoff Error: Large + Small Numbers", fig.align="center"}
%| echo: false
