...
### Shinylive App for Inverse CDF Sampling {#sec-inverse-cdf-app}

There is a [shinylive app](../shinyliveapps_compstat/app_inverse-cdf.html) to demonstrate the inverse-CDF method for generating random numbers from a target distribution by transforming uniform draws.
