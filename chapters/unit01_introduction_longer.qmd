...
quiz.mean.true
jitter <- rnorm(n, 0, 8)
data.frame(b0.test, b1.test, quiz.mean.true)
```
...
data.frame(b0.test, b1.test, quiz.mean.true, error,Test1.raw)
```
