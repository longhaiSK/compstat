...
::: {#fig-mixture-app .content-visible when-format="html"}
...
**Shinylive App Illustrating the EM Algorithm for a Normal Mixture.** The figure below replaces the frame-by-frame animation of earlier versions of
this chapter.
